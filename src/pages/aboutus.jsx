...
const AboutUs = ({ data }) => (
  <Layout>
    <Seo
      title='SWISS STARTUP GROUP – About us'
      desc='Get to know our team, advisory board, partners, supporters and sponsors, that offers a perfect network platform in the swiss startup ecosystem'
    />
    <Navbar />
    <Test>
    ...
    <Wrapper style={{ paddingTop: '2rem' }}>
      ...
      <div className='containertitleabout'>
        ...
        <p className='lh-copy'>
          Our values are part of our DNA. They guide the way we work with our
          partners, within our communities and with each other. Through
          integrity, passion, humility, simplicity and a focus on success, we
          have created a vibrant company culture where ideas can blossom, people
          can thrive and success can flourish.
        </p>
        <Values />
      </div>
      ...
      <div className='containertitle'>
        ...
        <p className='lh-copy mb5'>
          Our team consists of smart experts with a diverse set of experiences
          and backgrounds. As unique as we are individually, we share a mutual
          passion for the startup ecosystem and for doing excellent work for our
          clients and partners. Get to know our team below.
        </p>
      </div>
    </Wrapper>
    <FounderSlider />
        ...
        <div className='paddingtabs'>
          <div className='tabrow'>
            ...
            <article className='center pa3 pa4-ns'>
              <div className='tc'>
                <Img
                  fluid={data.tech4.childImageSharp.fluid}
                  className='br-100 dib '
                  style={Profile}
                  title=''
                  alt=''
            ...
            <Img fluid={data.tech5.childImageSharp.fluid} className="br-100 dib " style={Profile} title="" alt="" />
                <h3 className="f5 mb2">Besiana Bandilli</h3>
                <h4 className="f6 fw4 gray mt0">Head of Design & Marketing</h4>
              </div>
            </article> */}
          </div>
          {/* <div className="tabrow">
    ...
    <Wrapper
      style={{ paddingTop: '2em', paddingBottom: '1em', textAlign: 'center' }}
    >
      <span style={{ fontSize: '1.2em' }}>
        Find a complete list of our{' '}
        <a
          style={{ color: 'inherit', textDecoration: 'underline' }}
          href='https://www.swissstartupfactory.com/aboutus/'
        >
          Mentors
        </a>
      </span>
...
export const query = graphql`
  query {
    ...
    about16: file(relativePath: { eq: "images/emanuele.jpg" }) {
      childImageSharp {
        fluid(
          maxWidth: 1500
          traceSVG: { background: "#fff", color: "lightgrey" }
    ...
    about17: file(relativePath: { eq: "images/jingling.jpg" }) {
      childImageSharp {
        fluid(
          maxWidth: 1500
          traceSVG: { background: "#fff", color: "lightgrey" }
    ...
    about18: file(relativePath: { eq: "images/elena.jpg" }) {
      childImageSharp {
        fluid(
          maxWidth: 1500
          traceSVG: { background: "#fff", color: "lightgrey" }
    ...
    tech4: file(relativePath: { eq: "images/edgar.jpg" }) {
      childImageSharp {
        fluid(
          maxWidth: 1500
          traceSVG: { background: "#fff", color: "lightgrey" }
    ...
    tech5: file(relativePath: { eq: "images/bandilli.jpg" }) {
      childImageSharp {
        fluid(
          maxWidth: 1500
          traceSVG: { background: "#fff", color: "lightgrey" }
