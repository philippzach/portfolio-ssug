      ...
      <div className='flex-ns mt5 mb6'>
        ...
        <div className='w-100 w-two-thirds-ns pl0 pl4-ns pt4 tc tl-ns'>
          ...
          <p className='lh-copy b'>
            In the past 5 years investments in startups in Switzerland have
            gathered a lot of interest, which has led to a much more
            professional way of managing venture investments. Today venture
            investments have become a separate asset class for qualified
            investors called Venture Asset Management.
          </p>
          <p className='lh-copy'>
            Therefore the Swiss Startup Group has entrusted the newly founded
            Swiss Startup Capital AG who represents a fully dedicated Venture
            Asset Management offering in three divisons: Direct Investments -
            Indirect Investments - Corporate Venture Capital.
          </p>
        </div>
      </div>
      <Title>Team</Title>
