  ...
  <Seo title="SWISS STARTUP GROUP – Growth Services" desc="Dedicated growth services for corporate clients, startups and investors to grow faster. Accounting, Marketing, Finance, Communication and more." />
    ...
    <Wrapper style={{ paddingTop: '2rem', paddingBottom: '1rem' }}>
      ...
      <div className="containertitle">
        ...
        <p className="lh-copy">
        The growth services are just one part of our integrated services. Together we can make your startup grow faster and take it to the next level.
        </p>
        <p className="lh-copy">
        As a founder of a startup, you already have far too much on your plate. That's why we put growth services together with the aim of offering you dedicated services and keeping your back free so that you can concentrate on the topics that matter the most.
        </p>
        <p className="lh-copy">
      ...
      <article class="cf mv6">
        ...
        <div class="fl w-100 w-50-ns tr pa3-s pa3-m pl4-l">
         <p className="lh-copy mt3"><b>SWISS STARTUP TECH</b> enables companies to plan, design and transform the potential of digitalization and to turn the concept of blockchain into business results. The people involved love to build digital products and services, thus combining future customer needs with technological potential.
        ...
        <article class="cf mv6">
            ...
            <p className="lh-copy mt3">Once the products have been developed, they do not sell themselves. This is where another <b>SWISS STARTUP TECH</b> service comes in. With our <b>marketing 
                  and communication</b> experience, we help you position the products correctly and market them successfully.</p>
        ...
        <article class="mobileview cf mv6">
            ...
            Every startup receives customized advice and accounting solutions that are tailored to their needs.</p>
        ...
        <article class="cf mv6">
            ...
            <div class="fl w-100 w-50-ns tr pa4-s pa3-m pl4-l">
            <p className="lh-copy mt3">Red Bull Media House offers a wide range of premium media and content products across TV, mobile, digital, audio, and print. As a partner of the SWISS STARTUP GROUP, the <b>Red Bull Media House is part of our Growth Services</b>, thus facilitating innovative communication. From concept to know-how and equipment to implementation - everything from a single source.</p>
        ...
        <div className="mw6 center pa3" style={{ paddingTop: '2rem', paddingBottom: '5rem' }}>
            ...
            The SWISS STARTUP GROUP offers a unique networking platform including world-class experts from top institutions
            </h3>
            <p className="lh-copy">
            The SWISS STARTUP GROUP offers unique direct access to all stakeholders of the venture value chain such as investors, corporates, startups, top talents, mentors, academic partners and many more for your benefit.
            </p>
            <p className="lh-copy">
            Thanks to the experience of the Swiss Startup Group founder team and the high-level advisory board, we can provide you with fast-track access to an extensive network and top-down contacts to key decision makers.
            </p>
            <div className="tc">
