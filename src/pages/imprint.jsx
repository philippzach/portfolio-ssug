...
const Imprint = () => (
    ...
    <p className="lh-copy">You have the right at any time to obtain information about the data stored about you, its origin and recipient as well as the purpose of its storage.</p>
    </>   
    </Wrapper>
    </Layout>
)
