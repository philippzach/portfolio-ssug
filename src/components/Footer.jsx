    ...
    return (
      <StyledFooter>
        ...
        <div className='flex mobilecta'>
          ...
          <div className='w-50 flex items-center justify-center mobilebutton2'>
            <a
              style={{ color: 'white' }}
              href='mailto:virginia.beljean@ssut.ch'
            >
              Contact us
            </a>
          </div>
          ...
          >
            ...
            <li className='listitem'>
              <Link to='/investmentportfolio'>
                <span className='topmenu'>Investment Portfolio</span>
              </Link>
            </li>
            ...
            <li className='listitem'>
              ...
              <ul className=' list pl0 ma0 pt3 light-gray'>
                <li className='sublistitem'>
                  <a
                    style={{ color: 'rgb(211, 211, 211)' }}
                    href='https://swissstartupjobs.com'
                  >
                    Jobs
                  </a>
                </li>
                <li className='sublistitem'>
                  <Link style={{ color: 'rgb(211, 211, 211)' }} to='/blog'>
                    News
                  </Link>
                </li>
              </ul>
        ...
        <div className='socialcontainer pa1'>
          ...
          >
            <span style={{ fontWeight: '400', cursor: 'default' }}>
          ...
          >
            ...
            <span className='adresshover' itemProp='telephone'>
              <a href='tel:+411111111'>+41 1111111111</a>
            </span>
            <br />
            <span className='adresshover'>
              <a href='emailto:office@swissstartupfactory.com'>
                office@swissstartupfactory.com
              </a>
            </span>
          </address> */}
          <div className='pv3'>
            ...
            <a href='https://www.facebook.com/SwissStartUpGroup/'>
              <svg
                className='socialicon'
                viewBox='0 0 12 24'
                xmlns='http://www.w3.org/2000/svg'
        ...
        <div className='container'>
          <p className='copyright'>
            <Link to='/imprint' className='impressum'>
              ©2020 Swiss Startup Group
            </Link>
          </p>
        </div>
      </StyledFooter>
