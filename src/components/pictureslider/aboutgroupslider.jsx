        ...
        <div className="paddingfoundersabout">
          ...
          <div className="flex">
            <dl className="lh-title pr1-s pr2-m pr4-l mt0">
              ...
              <dd className="ml0 mb3">MacGuyver, Colt Seaver, Eddie the Eagle</dd>
            ...
            <dl className="lh-title mt0">
              ...
              <dd className="ml0 mb3">Netflix - 2 minutes before I fall asleep </dd>
        ...
        <div className="paddingfoundersabout">
          ...
          <div className="flex">
            <dl className="lh-title pr1-s pr2-m pr4-l mt0">
              ...
              <dd className="ml0 mb3">Professional footballer or tennis professional</dd>
            ...
            <dl className="lh-title mt0">
              ...
              <dd className="ml0 mb3">I had a crazy lunch with Dennis Rodman</dd>
        ...
        <div className="paddingfoundersabout">
          ...
          <div className="flex">
            ...
            <dl className="lh-title mt0">
              ...
              <dd className="ml0 mb3">Finding solutions to any kind of problem</dd>
        ...
        <div className="paddingfoundersabout">
          ...
          <div className="flex">
            <dl className="lh-title pr1-s pr2-m pr4-l mt0">
              ...
              <dd className="ml0 mb3">Motivate people, work hard, live intensively</dd>
              <dt className="f6 b mt2">I am not good at</dt>
              <dd className="ml0 mb3">Stuck in traffic and Algebra</dd>
              <dt className="f6 b mt2">Overrated</dt>
              <dd className="ml0 mb3">Being online constantly, anti-age-creams</dd>
            </dl>
            <dl className="lh-title mt0">
              <dt className="f6 b mt2">Underrated</dt>
              <dd className="ml0 mb3">Having time not to do anything, silence</dd>
              <dt className="f6 b mt2">I live</dt>
              <dd className="ml0 mb3">A wonderful, privileged life</dd>
              <dt className="f6 b mt2">A must read</dt>
              <dd className="ml0 mb3">Nassim Nicholas Taleb «Skin In The Game»</dd>
              <dt className="f6 b mt2">As a child I wanted to be</dt>
      ...
      <div className="w-100 w-60-ns pl3-ns flex items-center justify-center">
        <div className="paddingfoundersabout">
          ...
          <div className="flex">
            <dl className="lh-title pr1-s pr2-m pr4-l mt0">
              <dt className="f6 b">Never without</dt>
              <dd className="ml0 mb3">Purpose</dd>
              <dt className="f6 b mt2">Perfect holidays</dt>
              <dd className="ml0 mb3">Holidays spent with family and friends</dd>
              <dt className="f6 b mt2">Still on my bucket list </dt>
              <dd className="ml0 mb3">Be my own boss</dd>
              <dt className="f6 b mt2">Secret tip</dt>
              <dd className="ml0 mb3">Wouldn’t be secret if I told you</dd>
            </dl>
            <dl className="lh-title mt0">
              <dt className="f6 b mt2">My teen idol</dt>
              <dd className="ml0 mb3">My dad</dd>
              <dt className="f6 b mt2">Rituals</dt>
              <dd className="ml0 mb3">
                I always write down important thoughts? (Not sure if that’s a ritual, but it’s as close as I could get
                to having one)
              </dd>
              <dt className="f6 b mt2">Most grateful for</dt>
              <dd className="ml0 mb3">Opportunities</dd>
              <dt className="f6 b mt2">Unbelievable but true</dt>
              <dd className="ml0 mb3">I don’t speak Italian</dd>
            </dl>
          </div>
          <span className="arrows" />
        </div>
        ...
        <div className="paddingfoundersabout">
          ...
          <div className="flex">
            <dl className="lh-title pr1-s pr2-m pr4-l mt0">
              ...
              <dd className="ml0 mb3">If “Plan A” didn’t work, remember the alphabet has 25 more letters</dd>
            </dl>
            <dl className="lh-title mt0">
              <dt className="f6 b mt2">My teen idol</dt>
              <dd className="ml0 mb3">Aristotle Onassis</dd>
              <dt className="f6 b mt2">A perfect day</dt>
              <dd className="ml0 mb3">A never ending lunch with family/friends on the beach</dd>
              <dt className="f6 b mt2">Most grateful for</dt>
        ...
        <div className="paddingfoundersabout">
          ...
          <div className="flex">
            <dl className="lh-title pr1-s pr2-m pr4-l mt0">
              ...
              <dd className="ml0 mb3">Riding the Tran-Siberian from Moscow to Beijing</dd>
              <dt className="f6 b mt2">Favourite book</dt>
              <dd className="ml0 mb3">The Snowball - Warren Buffett and the Business of Life</dd>
              <dt className="f6 b mt2">Overrated</dt>
