          ...
          <ul className='nav__menu'>
            <li className='nav__menu-item'>
              <div className='sl-nav'>
                <ul>
                  <li>
                    <Link to='/factory' className='hovereffect' style={NavItem}>
                      Factory
                    </Link>
                    ...
                    <ul style={{ right: '-119px' }}>
                      ...
                      <a className='hoversubmenu' href='https://ccvs.ch/'>
                ...
                <ul>
                  <li>
                    ...
                    <ul style={{ right: '-41px' }}>
                      <a
                        className='hoversubmenu'
                        href='https://www.swissstartupjobs.com/'
                      >
                        <li>Jobs</li>
                      </a>
                      <Link className='hoversubmenu' to='/blog'>
                        <li style={{ paddingBottom: '5px' }}>News</li>
                      </Link>
                    </ul>
                  </li>
                </ul>
